...
<label>  
 ...
 {pecaTransferir && (
  ...
  <div className="modal-overlay">  
    <div className="modal">  
      <h3>🔄 Transferir Peça</h3>  <p><strong>{pecaTransferir.nome}</strong></p>  
...
value="MARAGOGI">MARAGOGI</option>  
       <option value="IPOJUCA RICARDO">Ipojuca Ricardo</option>  
        <option value="CHA GRANDE">Cha grande</option>  
      </select>  <div style={{ display: "flex", gap: 10, marginTop: 15 }}>  
  ...
  <div className="modal-overlay">  
    <div className="modal">  
      <h3>🔄 Transferir Moto</h3>  <p><strong>{motoTransferir.modelo}</strong></p>  
...
> 
  ...
  <option value="XEXEU">Xexeu</option>  
  <option value="CHA GRANDE">Cha grande</option>  
</select>  <div style={{ display: "flex", gap: 10 }}>  
  ...
  <div className="modal-overlay">  
    <div className="modal">  
      <h3>Cadastrar Moto</h3>  <input placeholder="Modelo" value={modeloMoto}  
